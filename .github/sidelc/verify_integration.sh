...
require 'queue.async {' 'Dependencies/minimuxer/Sources/FFIDispatcher.swift'
require 'var mountTask: Task<Bool, Error>? = nil' 'Dependencies/minimuxer/Sources/MinimuxerImpl.swift'
require '_ = await oldTask?.result' 'Dependencies/minimuxer/Sources/MinimuxerImpl.swift'
require 'try await mountDDI(docsPath: mountPath)' 'Dependencies/minimuxer/Sources/MinimuxerImpl.swift'

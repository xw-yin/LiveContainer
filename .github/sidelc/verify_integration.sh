...
require 'collectionViewLayout.sectionInsetReference = .fromSafeArea' 'AltStore/Browse/BrowseViewController.swift'
require 'override func viewWillTransition(to size:' 'AltStore/Browse/BrowseViewController.swift'
require 'let safeAreaWidth = collectionView.safeAreaInsets.left + collectionView.safeAreaInsets.right' 'AltStore/Browse/BrowseViewController.swift'
require 'func configureCardMargins(for cell: UICollectionViewCell)' 'AltStore/Browse/BrowseViewController.swift'
require 'config.contentInsetsReference = .safeArea' 'AltStore/Browse/FeaturedViewController.swift'
require 'override func viewWillTransition(to size:' 'AltStore/Browse/FeaturedViewController.swift'
require 'func configureCardMargins(for cell: UICollectionViewCell)' 'AltStore/Browse/FeaturedViewController.swift'

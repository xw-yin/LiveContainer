...
require 'self.textLabel.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 16)' 'AltStore/My Apps/InstalledAppsCollectionHeaderView.swift'
require 'self.button.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -16)' 'AltStore/My Apps/InstalledAppsCollectionHeaderView.swift'

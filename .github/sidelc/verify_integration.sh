...
require_host 'performRefreshForRealWithServer:' 'SideStoreSupport/XPCClient.m'
reject_host 'PrivateIntentRunner.run' 'SideStoreSupport/SideStoreClient.swift'
reject_host 'performRefreshForRealWithIdentifier:' 'SideStoreSupport/XPCClient.m'

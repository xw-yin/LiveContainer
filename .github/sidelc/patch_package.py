...
def patch_minimuxer():
    ...
    gateway_path = os.path.join(sidestore_dir, 'Dependencies/minimuxer/Sources/IdeviceGateway.swift')
    ...
    scanner_path = os.path.join(sidestore_dir, 'Dependencies/minimuxer/Sources/Services/NetworkIfaceScanner.swift')
